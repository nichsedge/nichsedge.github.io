...
export default function HomeClient() {
  ...
  return (
    <div className="min-h-screen relative">
        ...
        {showOverlay && (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span>[ALERT: NEURAL LINK SYNCHRONIZED]</span>
            </div>
            <div className="text-[9px] text-text-3 mt-1.5">ambient matrix interference activated</div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <section className="pt-24 pb-16 px-6 relative overflow-hidden group">
        ...
        <motion.div {...FADE_UP} className="relative z-20">
          ...
          >
             ...
             {isNSM ? 'NEURAL_LINK_SYNCHRONIZED' : 'ESTABLISHING_LINK... OK (Click to Sync)'}
          </button>
          <h1 className="text-4xl md:text-5xl font-bold text-text-0 leading-tight mb-8 tracking-tight">
            <GlitchText text={resumeData.profile.tagline.split(' ').slice(0, 4).join(' ')} /> <span className="text-accent underline decoration-accent/20 underline-offset-4">{resumeData.profile.tagline.split(' ')[4]}</span> and <span className="text-accent underline decoration-accent/20 underline-offset-4">{resumeData.profile.tagline.split(' ')[6]}</span> {resumeData.profile.tagline.split(' ')[7]}.
          </h1>
          ...
          <div className="flex flex-wrap gap-6 items-center">
            ...
            >
              ...
              <span className="relative z-10 flex items-center gap-2">Access Archive <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" /></span>
            </motion.a>
      ...
      {/* Career Pipeline */}
      <Section id="work" label="01 — career pipeline" isNSM={isNSM}>
        <div className="mb-12">
           <CareerPipeline />
        </div>
        <div className="mb-16">
      ...
      {/* Expertise Graph */}
      <Section id="skills" label="02 — neural network" isNSM={isNSM}>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 md:gap-4">
                ...
                <div className="bg-bg-1 p-3 md:p-4 border border-border-subtle group hover:border-accent/30 transition-colors">
                  <div className="font-mono text-[9px] uppercase tracking-widest text-accent mb-2">IDEs</div>
                  <div className="flex flex-wrap gap-1.5">
      ...
      {/* Data Oracle */}
      <Section id="oracle" label="03 — data oracle (AI)" isNSM={isNSM}>
         <DataOracle />
      </Section>

      {/* Human Runtime Environment */}
      <Section id="human-runtime" label="04 — human runtime environment" isNSM={isNSM}>
         <HumanRuntime />
      </Section>
      ...
      <footer className="py-12 border-t border-border-subtle bg-bg-1 px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col gap-1 items-end">
             ...
             <span className="font-mono text-[8px] uppercase tracking-widest text-text-3 opacity-20">Easter Egg: Type 'NSM'</span>
          </div>
        </div>
      </footer>
    </div>
