...
export function GeoRouting() {
  ...
  return (
    <div className={`fixed top-24 left-[calc(50%+450px)] z-40 hidden min-[1320px]:flex flex-col items-start gap-2 pointer-events-none w-64 hud-widget transition-all duration-300 ${
