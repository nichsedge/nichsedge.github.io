...
export function SystemStatsWidget() {
  ...
  return (
    <div className="fixed top-[18px] right-6 2xl:right-auto 2xl:left-[calc(50%+370px)] z-50 hidden xl:flex items-center gap-2 bg-bg/40 backdrop-blur-md px-2 py-1.5 border border-border-subtle rounded-sm font-mono text-[9px] text-text-3 uppercase tracking-tighter select-none shadow-[0_4px_12px_rgba(0,0,0,0.3)] sys-stats-widget">
      <div className="flex items-center gap-1.5 font-bold tracking-widest text-accent/80 pr-0.5">
      ...
      <div className="flex items-center gap-1 group">
        ...
        <span className="opacity-50">TPUT:</span>
      ...
      <div className="flex items-center gap-1 group hidden 2xl:flex">
        ...
        <span className="opacity-50">NDS:</span>
