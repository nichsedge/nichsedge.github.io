...
export function SystemStatsWidget() {
  ...
  return (
    <div className="fixed top-[18px] left-[calc(50%+450px)] z-40 hidden min-[1320px]:flex items-center gap-2 bg-bg/40 backdrop-blur-md px-2 py-1.5 border border-border-subtle rounded-sm font-mono text-[9px] text-text-3 uppercase tracking-tighter select-none shadow-[0_4px_12px_rgba(0,0,0,0.3)] sys-stats-widget">
